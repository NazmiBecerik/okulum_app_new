...
import 'package:okulum_app/app/modules/common/widgets/buttons/attachmentBox/attachment_box.dart';
...
Future<void> showAttachmentDialog({required Function(dynamic, AttachmentType) onTap, bool showPhotoPreview = true}) async {
  await Get.bottomSheet(AttachmentBox(onTap: onTap, showPhotoPreview: showPhotoPreview));
}
