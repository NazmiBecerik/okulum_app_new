...
class DatePickerField extends StatelessWidget {
            ...
            child: Card(
              ...
              child: Padding(
                ...
                child: Row(
                  ...
                  children: [
                    if (isArrowBackIcon) InkWell(onTap: () => arrowBackOnTap!(), child: const Icon(Icons.arrow_back_ios_new_outlined)),
                    Row(
                      children: [
                        ...
                        ValueListenableBuilder(
                          ...
                          builder: (context, value, child) =>
                              CustomText.custom(value != null ? DateFormat("dd/MM/yyyy").format(value as DateTime) : hintText ?? "Tarih Seçiniz"),
                        ),
                      ],
                    ),
                    if (isForwardIcon) InkWell(onTap: () => forwardOnTap!(), child: const Icon(Icons.arrow_forward_ios_rounded)),
                  ],
                ),
              ),
            ),
  ...
  Padding get labelText => Padding(
    ...
    child: CustomText.high(label! + (isRequired ? '*' : ''), textColor: ColorTable.getTextColor),
  );
